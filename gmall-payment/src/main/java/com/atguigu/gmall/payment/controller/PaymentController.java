...
//        String subject = request.getParameter("subject");
       ...
       //boolean signVerified = AlipaySignature.rsaCheckV1(map,alipaypublicKey,charset,sign_type);验签
...
//        }
        ...
        mv.addObject("sign","aliPaySign:6226350");
        String  uuid = UUID.randomUUID().toString();
        mv.addObject("trade_no","alibaba"+uuid);
